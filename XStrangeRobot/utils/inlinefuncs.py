...
from XStrangeRobot import pbot as app 
from XStrangeRobot import arq
from XStrangeRobot.services.keyboard import Ikb
from XStrangeRobot.utils.pluginhelper import convert_seconds_to_minutes as time_convert, fetch
from XStrangeRobot.services.tasks import _get_tasks_text, all_tasks, rm_task
from XStrangeRobot.services.types import InlineQueryResultCachedDocument
from XStrangeRobot.modules.info import get_chat_info, get_user_info
from XStrangeRobot.utils.functions import test_speedtest
from XStrangeRobot.utils.pastebin import paste
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main bot", url="https://t.me/XStrangexbot"),
        InlineKeyboardButton(
    ...
    msg = f"""
**[XStrange Robot ❤️](https://t.me/XStrangeSupport):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
