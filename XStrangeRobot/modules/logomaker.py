...
from XStrangeRobot import telethn as tbot, ubot2
...
async def logo_gen(event):
    ...
    if event.reply_to_msg_id:
        ...
        fpath_ = glob.glob("./XStrangeRobot/resources/fonts/*")
    ...
    if os.path.exists(flnme):
        await tbot.send_file(
            event.chat_id,
            file=flnme,
            caption="Logo by [XStrange Robot](https://t.me/XStrangexbot)",
    ...
    if os.path.exists(font_):
        if not font_.startswith("./XStrangeRobot/resources/fonts"):
            os.remove(font_)
