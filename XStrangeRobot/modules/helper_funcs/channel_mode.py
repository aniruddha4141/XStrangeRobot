...
from XStrangeRobot import DRAGONS, DEV_USERS, dispatcher
from XStrangeRobot.modules.helper_funcs.decorators import XStrangecallback
...
@XStrangecallback(pattern="anoncb")
