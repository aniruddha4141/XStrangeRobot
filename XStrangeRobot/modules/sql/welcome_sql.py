...
from XStrangeRobot.modules.helper_funcs.msg_types import Types
from XStrangeRobot.modules.sql import BASE, SESSION
...
DEFAULT_WELCOME_MESSAGES = [
    ...
    "The only verdict is vengeance; a vendetta, held as a votive not in TheAnnyOP, for the value and veracity of such shall one day vindicate the vigilant and the virtuous.",  # V for Vendetta
