...
from XStrangeRobot.__main__ import STATS, TOKEN, USER_INFO
from XStrangeRobot.modules.sql import SESSION
import XStrangeRobot.modules.sql.userinfo_sql as sql
from XStrangeRobot.modules.disable import DisableAbleCommandHandler
from XStrangeRobot.modules.sql.global_bans_sql import is_user_gbanned
from XStrangeRobot.modules.sql.afk_sql import is_afk, set_afk
from XStrangeRobot.modules.sql.users_sql import get_user_num_chats
from XStrangeRobot.modules.helper_funcs.chat_status import sudo_plus
from XStrangeRobot.modules.helper_funcs.extraction import extract_user
from XStrangeRobot import telethn
...
def stats(update: Update, context: CallbackContext):
    stats = "<b>╔═━「 Current XStrange Statistics 」</b>\n" + "\n".join([mod.__stats__() for mod in STATS])
    result = re.sub(r"(\d+)", r"<code>\1</code>", stats)
    result += "\n<b>╘═━「 Powered By aniruddha4141 」</b>"
    update.effective_message.reply_text(
        result,
        parse_mode=ParseMode.HTML, 
        disable_web_page_preview=True
