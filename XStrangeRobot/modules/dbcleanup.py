...
import XStrangeRobot.modules.sql.global_bans_sql as gban_sql
import XStrangeRobot.modules.sql.users_sql as user_sql
from XStrangeRobot import DEV_USERS, OWNER_ID, dispatcher
