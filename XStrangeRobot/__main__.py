...
import XStrangeRobot.modules.sql.users_sql as sql
from sys import argv
from typing import Optional
from telegram import __version__ as peler
from platform import python_version as memek
from XStrangeRobot import (
    ALLOW_EXCL,
    CERT_PATH,
    DONATION_LINK,
    LOGGER,
...
from XStrangeRobot.modules import ALL_MODULES
from XStrangeRobot.modules.helper_funcs.chat_status import is_user_admin
from XStrangeRobot.modules.helper_funcs.misc import paginate_modules
...
from XStrangeRobot.modules.language import gs
...
XSTRANGE_IMG = "https://telegra.ph/file/ac669f5736ec2d0ec8657.jpg"
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("XStrangeRobot.modules." + module_name)
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(text=gs(chat.id, "about_button"), callback_data="XStrange_"),
                        ],
                        [
                        ...
                        [
                            InlineKeyboardButton(
                                text=gs(chat.id, "add_bot_to_group_button"), url="t.me/XStrangexbot?startgroup=new"),
                        ]
                    ]
                ),
                parse_mode=ParseMode.MARKDOWN,
    ...
    if query.data == "XStrange_":
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(text=gs(chat.id, "notes_button"), callback_data="XStrange_notes"),
                    ],
                    [
                        InlineKeyboardButton(text=gs(chat.id, "support_chat_link_button"), callback_data="XStrange_support"),
                        InlineKeyboardButton(text="Credits", callback_data="XStrange_credit"),
                    ],
                    [
                        InlineKeyboardButton(text=gs(chat.id, "source_button"), url="https://github.com/aniruddha4141/XStrangeRobot"),
                    ],
                    [
                    InlineKeyboardButton(text=gs(chat.id, "back_button"), callback_data="XStrange_back"),
                    ]
                ]
            ),
        )
        ...
        query.message.edit_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        ...
                        [
                            InlineKeyboardButton(text=gs(chat.id, "add_bot_to_group_button"), url="t.me/XStrangexbot?startgroup=new"),
                        ]
                    ]
                ),
                parse_mode=ParseMode.MARKDOWN,
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text=gs(chat.id, "back_button"), callback_data="XStrange_"),
                    ]
                ]
            ),
        )
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(text=gs(chat.id, "updates_channel_link_button"), url="https://t.me/XstrangeUpdate"),
                    ],
                    [
                        InlineKeyboardButton(text=gs(chat.id, "back_button"), callback_data="XStrange_"),
                    ]
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text="TheAnnyOP", url="https://github.com/aniruddha4141"),
                    ],
                    [
