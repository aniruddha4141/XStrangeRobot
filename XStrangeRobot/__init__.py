...
def get_user_list(__init__, key):
    with open("{}/XStrangeRobot/{}".format(os.getcwd(), __init__), "r") as json_file:
        return json.load(json_file)[key]

# enable logging
FORMAT = "[XStrangeRobot] %(message)s"
logging.basicConfig(
...
LOGGER = logging.getLogger('[XStrangeRobot]')
LOGGER.info("XStrange is starting. | An aniruddha4141 Project Parts. | Licensed under GPLv3.")
LOGGER.info("Not affiliated to other anime or Villain in any way whatsoever.")
LOGGER.info("Project maintained by: github.com/aniruddha4141 (t.me/saint_foire)")
...
if ENV:
    ...
    from XStrangeRobot.config import Development as Config
...
from XStrangeRobot.modules.helper_funcs.handlers import (
